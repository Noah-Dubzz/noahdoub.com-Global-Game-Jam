...
[RequireComponent(typeof(BoundsChecks))]
public class Enemy : MonoBehaviour
{
    ...
    protected RegularProjectileEnemy enemy;
    ...
    protected BoundsChecks bndCheck;
    ...
    void FixedUpdate()
    {
        if (bndCheck.LocIs(BoundsChecks.eScreenLocs.offDown))
        {
            Destroy(gameObject);
        }
        ...
        if (p != null)
        {
            if (otherGO.GetComponent<ProjectileHero>() != null)
            {
                ...
                if (health <= 0)
                {
                    ...
                    waveSpawner.waves[waveSpawner.currentWaveIndex].enemiesLeft = waveSpawner.waves[waveSpawner.currentWaveIndex].enemiesLeft - 1;
                    Debug.Log(waveSpawner.waves[waveSpawner.currentWaveIndex].enemiesLeft);
                }
            }
            Destroy(otherGO);
